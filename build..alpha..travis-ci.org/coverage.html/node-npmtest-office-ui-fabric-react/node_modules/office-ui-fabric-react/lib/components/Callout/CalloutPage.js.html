...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Callout/CalloutPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Callout/CalloutPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Callout/</a> &#187; CalloutPage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var data_1 = require("../CommandBar/examples/data");</span>
<span class="cstat-no" title="statement not covered" >var Callout_Basic_Example_1 = require("./examples/Callout.Basic.Example");</span>
<span class="cstat-no" title="statement not covered" >var Callout_Nested_Example_1 = require("./examples/Callout.Nested.Example");</span>
<span class="cstat-no" title="statement not covered" >var Callout_Directional_Example_1 = require("./examples/Callout.Directional.Example");</span>
<span class="cstat-no" title="statement not covered" >var Callout_Cover_Example_1 = require("./examples/Callout.Cover.Example");</span>
<span class="cstat-no" title="statement not covered" >var CalloutBasicExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Callout/examples/Callout.Basic.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CalloutNestedExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Callout/examples/Callout.Nested.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CalloutDirectionalExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Callout/examples/Callout.Directional.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CalloutCoverExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Callout/examples/Callout.Cover.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CalloutPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(CalloutPage, _super);</span>
<span class="fstat-no" title="function not covered" >    function CalloutPage() {</span>
<span class="cstat-no" title="statement not covered" >        return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
    }
<span class="cstat-no" title="statement not covered" >    CalloutPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        var cmdBarParamsTextAndIcons = { items: data_1.textOnlyItems, farItems: null };</span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Callout', componentName: 'CalloutExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    return CalloutPage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.CalloutPage = CalloutPage;</span>
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Dialog/</a> &#187; DialogPage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var Dialog_Basic_Example_1 = require("./examples/Dialog.Basic.Example");</span>
<span class="cstat-no" title="statement not covered" >var Dialog_LargeHeader_Example_1 = require("./examples/Dialog.LargeHeader.Example");</span>
<span class="cstat-no" title="statement not covered" >var Dialog_Blocking_Example_1 = require("./examples/Dialog.Blocking.Example");</span>
<span class="cstat-no" title="statement not covered" >var DialogBasicExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Dialog/examples/Dialog.Basic.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var DialogLargeHeaderExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Dialog/examples/Dialog.LargeHeader.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var DialogBlockingExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Dialog/examples/Dialog.Blocking.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var DialogPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(DialogPage, _super);</span>
<span class="fstat-no" title="function not covered" >    function DialogPage() {</span>
<span class="cstat-no" title="statement not covered" >        return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
    }
<span class="cstat-no" title="statement not covered" >    DialogPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Dialog', componentName: 'DialogExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    return DialogPage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.DialogPage = DialogPage;</span>
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib-amd/demo/GettingStartedPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib-amd/demo/GettingStartedPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib-amd/demo/</a> &#187; GettingStartedPage.js</div>
</div>
<div class="body">
...
define(["require", "exports", "react", "office-ui-fabric-react/lib/Link", "@uifabric/example-app-base", "./GettingStartedPage.scss"], <span class="fstat-no" title="function not covered" >function (require, exports, React, Link_1, example_app_base_1) {</span>
    "use strict";
<span class="cstat-no" title="statement not covered" >    Object.defineProperty(exports, "__esModule", { value: true });</span>
<span class="cstat-no" title="statement not covered" >    var GettingStartedPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >        __extends(GettingStartedPage, _super);</span>
<span class="fstat-no" title="function not covered" >        function GettingStartedPage() {</span>
<span class="cstat-no" title="statement not covered" >            return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
        }
<span class="cstat-no" title="statement not covered" >        GettingStartedPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            return (React.createElement("div", { className: 'ms-GettingStartedPage' },</span>
...
<span class="cstat-no" title="statement not covered" >        return GettingStartedPage;</span>
    }(React.Component));
<span class="cstat-no" title="statement not covered" >    exports.GettingStartedPage = GettingStartedPage;</span>
});
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Facepile/FacepilePage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Facepile/FacepilePage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Facepile/</a> &#187; FacepilePage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var Facepile_AddFace_Example_1 = require("./examples/Facepile.AddFace.Example");</span>
<span class="cstat-no" title="statement not covered" >var Facepile_Basic_Example_1 = require("./examples/Facepile.Basic.Example");</span>
<span class="cstat-no" title="statement not covered" >var Facepile_Overflow_Example_1 = require("./examples/Facepile.Overflow.Example");</span>
<span class="cstat-no" title="statement not covered" >var FacepileAddFaceExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Facepile/examples/Facepile.AddFace.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var FacepileBasicExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Facepile/examples/Facepile.Basic.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var FacepileOverflowExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Facepile/examples/Facepile.Overflow.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var FacepilePage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(FacepilePage, _super);</span>
<span class="fstat-no" title="function not covered" >    function FacepilePage() {</span>
<span class="cstat-no" title="statement not covered" >        return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
    }
<span class="cstat-no" title="statement not covered" >    FacepilePage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Facepile', componentName: 'FacepileExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    return FacepilePage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.FacepilePage = FacepilePage;</span>
&nbsp;

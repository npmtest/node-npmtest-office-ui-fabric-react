...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Button/ButtonPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Button/ButtonPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/Button/</a> &#187; ButtonPage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var Checkbox_1 = require("office-ui-fabric-react/lib/Checkbox");</span>
<span class="cstat-no" title="statement not covered" >var Button_Default_Example_1 = require("./examples/Button.Default.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_ContextualMenu_Example_1 = require("./examples/Button.ContextualMenu.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_Primary_Example_1 = require("./examples/Button.Primary.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_Compound_Example_1 = require("./examples/Button.Compound.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_Command_Example_1 = require("./examples/Button.Command.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_Icon_Example_1 = require("./examples/Button.Icon.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_Anchor_Example_1 = require("./examples/Button.Anchor.Example");</span>
<span class="cstat-no" title="statement not covered" >var Button_ScreenReader_Example_1 = require("./examples/Button.ScreenReader.Example");</span>
<span class="cstat-no" title="statement not covered" >require("./examples/Button.Basic.Example.scss");</span>
<span class="cstat-no" title="statement not covered" >var Link_1 = require("../../Link");</span>
<span class="cstat-no" title="statement not covered" >var ButtonDefaultExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Default.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonPrimaryExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Primary.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonCompoundExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Compound.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonCommandExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Command.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonIconExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Icon.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonAnchorExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.Anchor.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonScreenReaderExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.ScreenReader.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonContextualMenuExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Button/examples/Button.ContextualMenu.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var ButtonPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(ButtonPage, _super);</span>
<span class="fstat-no" title="function not covered" >    function ButtonPage() {</span>
...
<span class="cstat-no" title="statement not covered" >    ButtonPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'Button', componentName: 'ButtonExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    ButtonPage.prototype._onDisabledChanged = <span class="fstat-no" title="function not covered" >function (ev, disabled) {</span></span>
<span class="cstat-no" title="statement not covered" >        this.setState({</span>
            areButtonsDisabled: disabled
        });
    };
<span class="cstat-no" title="statement not covered" >    return ButtonPage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.ButtonPage = ButtonPage;</span>
&nbsp;

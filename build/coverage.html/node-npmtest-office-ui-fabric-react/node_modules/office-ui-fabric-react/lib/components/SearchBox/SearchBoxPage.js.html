...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/SearchBox/SearchBoxPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/SearchBox/SearchBoxPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/SearchBox/</a> &#187; SearchBoxPage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var SearchBox_Small_Example_1 = require("./examples/SearchBox.Small.Example");</span>
<span class="cstat-no" title="statement not covered" >var SearchBox_FullSize_Example_1 = require("./examples/SearchBox.FullSize.Example");</span>
<span class="cstat-no" title="statement not covered" >var SearchBoxSmallExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/SearchBox/examples/SearchBox.Small.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var SearchBoxFullSizeExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/SearchBox/examples/SearchBox.FullSize.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var SearchBoxPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(SearchBoxPage, _super);</span>
<span class="fstat-no" title="function not covered" >    function SearchBoxPage() {</span>
<span class="cstat-no" title="statement not covered" >        return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
    }
<span class="cstat-no" title="statement not covered" >    SearchBoxPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'SearchBox', componentName: 'SearchBoxExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    return SearchBoxPage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.SearchBoxPage = SearchBoxPage;</span>
&nbsp;

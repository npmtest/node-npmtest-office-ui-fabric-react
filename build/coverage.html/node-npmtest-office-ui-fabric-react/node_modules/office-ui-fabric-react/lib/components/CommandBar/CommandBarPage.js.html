...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/CommandBar/CommandBarPage.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/CommandBar/CommandBarPage.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-office-ui-fabric-react/node_modules/office-ui-fabric-react/lib/components/CommandBar/</a> &#187; CommandBarPage.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >var data_1 = require("./examples/data");</span>
<span class="cstat-no" title="statement not covered" >var CommandBar_Basic_Example_1 = require("./examples/CommandBar.Basic.Example");</span>
<span class="cstat-no" title="statement not covered" >var CommandBar_NonFocusable_Example_1 = require("./examples/CommandBar.NonFocusable.Example");</span>
<span class="cstat-no" title="statement not covered" >var CommandBarBasicExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/CommandBar/examples/CommandBar.Basic.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CommandBarNoFocusableItemsExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/CommandBar/examples/CommandBar.NonFocusable.Example.tsx');</span>
<span class="cstat-no" title="statement not covered" >var CommandBarPage = (<span class="fstat-no" title="function not covered" >function (_super) {</span></span>
<span class="cstat-no" title="statement not covered" >    __extends(CommandBarPage, _super);</span>
<span class="fstat-no" title="function not covered" >    function CommandBarPage() {</span>
<span class="cstat-no" title="statement not covered" >        return _super !== null &amp;&amp; _super.apply(this, arguments) || this;</span>
    }
<span class="cstat-no" title="statement not covered" >    CommandBarPage.prototype.render = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        var cmdBarParamsTextAndIcons = { items: data_1.items, farItems: data_1.farItems };</span>
<span class="cstat-no" title="statement not covered" >        return (React.createElement(example_app_base_1.ComponentPage, { title: 'CommandBar', componentName: 'CommandBarExample', exampleCards: React.createElement("div", null,</span>
...
<span class="cstat-no" title="statement not covered" >    return CommandBarPage;</span>
}(React.Component));
<span class="cstat-no" title="statement not covered" >exports.CommandBarPage = CommandBarPage;</span>
&nbsp;
